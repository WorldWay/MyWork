...
public class MyDecoder implements ProtocolDecoder {
	 ...
	 */
	public MyDecoder(String delimiter) {
	 ...
	 *            The line delimiter to use
	 */
	public MyDecoder(LineDelimiter delimiter) {
	 ...
	 *            The line delimiter to use
	 */
	public MyDecoder(Charset charset, String delimiter) {
	 ...
	 *            The line delimiter to use
	 */
	public MyDecoder(Charset charset, LineDelimiter delimiter) {
		if (charset == null) {
	...
	/**
	 * @return the allowed maximum size of the line to be decoded. If the size
	 *         of the line to be decoded exceeds this value, the decoder will
	 *         throw a {@link BufferDataException}. The default value is
	 *         <tt>1024</tt> (1KB).
	 */
	...
	/**
	 * @return the allowed buffer size used to store the decoded line in the
	 *         Context instance.
	 */
	 ...
	 * 
	 * @param session
	 *            The session for which we want the context
	 */
	 ...
	 */
	protected void writeText(IoSession session, byte[] text,
